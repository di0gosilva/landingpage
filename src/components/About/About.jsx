export default function About() {
  return (
    <main className="flex flex-1 flex-col items-start justify-center gap-6 text-lg">
      ...
      <p>- Criei esse projeto de controle financeiro como parte do trabalho final da disciplina de Lógica de Programação. Escolhi desenvolver um sistema para controle de gastos porque era algo que já fazia parte da minha rotina, porém utilizava apenas uma planilha no Google. A ideia de transformar isso em um site surgiu da vontade de facilitar o registro dos meus gastos mensais e ter um controle mais eficiente e prático sobre minhas finanças. Além disso, foi uma ótima oportunidade de aplicar na prática os conceitos aprendidos durante a matéria.</p>
